...
import com.example.myapplication.util.clusterutil.projection.Bounds;
...
import com.example.myapplication.util.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.myapplication.util.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.myapplication.util.clusterutil.clustering.algo
