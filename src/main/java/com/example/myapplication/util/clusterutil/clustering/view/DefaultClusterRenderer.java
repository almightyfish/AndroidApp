...
import static com.example.myapplication.util.clusterutil.MarkerManager.MAX_DISTANCE_AT_ZOOM;
...
import com.example.myapplication.util.clusterutil.MarkerManager;
...
import com.example.myapplication.util.clusterutil.projection.Point;
import com.example.myapplication.util.clusterutil.projection.SphericalMercatorProjection;
import com.example.myapplication.util.clusterutil.ui.IconGenerator;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.example.myapplication.util.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.example.myapplication.util.clusterutil.ui.SquareTextView makeSquareTextView(
            Context context) {
        com.example.myapplication.util.clusterutil.ui.SquareTextView squareTextView =
                new com.example.myapplication.util.clusterutil.ui.SquareTextView(context);
